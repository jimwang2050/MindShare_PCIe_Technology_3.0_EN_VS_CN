...
- [12.1 Physical Layer - Logical (Gen3) — 物理层 - 逻辑 (Gen3)](#sec-12-1)
- [12.2 Physical Layer - Logical (Gen3) — 物理层 - 逻辑 (Gen3)](#sec-12-2)
- [12.3 Physical Layer - Logical (Gen3) — 物理层 - 逻辑 (Gen3)](#sec-12-3)
- [12.4 Physical Layer - Logical (Gen3) — 物理层 - 逻辑 (Gen3)](#sec-12-4)
- [12.5 Physical Layer - Logical (Gen3) — 物理层 - 逻辑 (Gen3)](#sec-12-5)
...
|VRX‐IDLE‐ DET‐DIFFp‐ p|65 (min) 175 (max)|||mV|Electrical Idle detect threshold at t...|
...
|ZRX‐‐DC|40 (min) 60 (max)|40 (min) 60 (max)|Bounded by RLRX‐CM||DC impedance needed for Receiver Detect.|
...
|RLRX‐‐CM|6 (min)|6 (min)|6 (min) for 0.05 ‐ 2.5 GHz, 5 (min) f...|dB|Common mode Rx return loss|
...
|VRX‐DIFF‐PP‐CC|175 （最小） 1200 （最大）|120（最小） 1200（最大）|间接指定|mV|公共时钟接收器的峰峰值差分电压灵敏度。|
|VRX‐DIFF‐PP‐DC|175 （最小） 1200 （最大）|100（最小） 1200（最大）|间接指定|mV|数据时钟接收器的峰峰值差分电压灵敏度。|
...
|RLRX‐‐CM|6（最小）|6（最小）|6（最小） ，频率 0.05 ‐ 2.5 GHz， 5（最小） ，频率 >...|dB|共模 Rx 回波损耗|
...
|1|链路号 • 不支持 Gen3 的端口：0‐255，PAD • 支持 Gen...|
...
状态中使用；在所有其他状态中保留。|
|7|对于 Gen1 或 Gen2 GT/s，TS1 标识符 (4Ah) 编码为...|
|8|对于 Gen1 或 Gen2，TS1 标识符 (4Ah) 编码为 D10....|
...
|14‐15|对于 Gen1 或 Gen2，TS1 标识符 (4Ah) 编码为 D10....|
...
|14‐15|• 对于 Gen1 或 Gen2，TS2 标识符 (45h) 编码为 D5...|
