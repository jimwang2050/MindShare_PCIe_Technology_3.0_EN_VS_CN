...
**已知**: 当前 **16 个** chunk 是空/占位
  - **Ch0 前言 (8 个)**: 有意保留英文原文，不翻译 — `chunk0004/0018/0024/0031/0037/0040/0049/0059`
  - **Ch1-Ch4 (8 个)**: 短标题/章节划分页 — 可选补全，不影响阅读
**工具**: `tools/qa_chunk_coverage.py` 已覆盖
**修复**: Ch0 已确认不翻译；Ch1-Ch4 可选择性补全

### A2. 短翻译 (< 200 bytes 但 > 50 bytes)
**检测**: 输出文件 50-200 bytes (可能是图注、表格单元格)
**已知**: Ch0 部分 chunk 为短尺寸（封面/目录页），有意保留英文原文
**判断**: 对照源 `chunks/chunkNNNN.md` 大小；Ch0 内的短 chunk 为预期行为
