...
- [2.1 PCI Interrupt Handling — PCIe 架构概述](#sec-2-1)
- [2.2 PCI Error Handling — PCIe 架构概述](#sec-2-2)
- [2.3 PCI Address Space Map — PCIe 架构概述](#sec-2-3)
- [2.4 PCI Configuration Cycle Generation — PCIe 架构概述](#sec-2-4)
- [2.5 PCI Function Configuration Register Space — PCIe 架构概述](#sec-2-5)
- [2.6 PCI Express Technology — PCIe 架构概述](#sec-2-6)
- [2.7 Higher-bandwidth PCI — PCIe 架构概述](#sec-2-7)
- [2.8 PCI Express Technology — PCIe 架构概述](#sec-2-8)
- [2.9 Limitations of 66 MHz PCI bus — PCIe 架构概述](#sec-2-9)
- [2.10 Signal Timing Problems with the Parallel PCI Bus Model be... — PCIe 架构概述](#sec-2-10)
- [2.11 Introducing PCI-X — PCIe 架构概述](#sec-2-11)
- [2.12 PCI-X System Example — PCIe 架构概述](#sec-2-12)
- [2.13 PCI-X Transactions — PCIe 架构概述](#sec-2-13)
- [2.14 PCI-X Features — PCIe 架构概述](#sec-2-14)
- [2.15 Split-Transaction Model — PCIe 架构概述](#sec-2-15)
- [2.16 PCI Express Technology — PCIe 架构概述](#sec-2-16)
- [2.17 Message Signaled Interrupts — PCIe 架构概述](#sec-2-17)
- [2.18 Transaction Attributes — PCIe 架构概述](#sec-2-18)
- [2.19 Higher Bandwidth PCI-X — PCIe 架构概述](#sec-2-19)
- [2.20 Problems with the Common Clock Approach of PCI and PCI-X ... — PCIe 架构概述](#sec-2-20)
- [2.21 PCI-X 2.0 Source-Synchronous Model — PCIe 架构概述](#sec-2-21)
- [2.22 PCI Express Technology — PCIe 架构概述](#sec-2-22)
- [2.23 _2 PCIe Architecture Overview_ — PCIe 架构概述](#sec-2-23)
- [2.24 Previous Chapter — PCIe 架构概述](#sec-2-24)
- [2.25 This Chapter — PCIe 架构概述](#sec-2-25)
- [2.26 The Next Chapter — PCIe 架构概述](#sec-2-26)
...
**----- 图片文字开始 -----**<br>
处理器 处理器<br>FSB（前端总线）<br>AGP<br>4x<br>GFX（图形显示）<br>RDRAM<br>内存控制器集线器<br>P64H (Intel 860 MCH)<br>插槽 PCI-66MHz 集线器接口 RDRAM<br>P64H<br>集线器接口 插槽<br>IDE<br>PCI-33MHz<br>CD HDD<br>USB 2.0 IO 控制器集线器<br>(ICH2) IEEE SCSI<br>LPC 1394<br>Super AC'97<br>IO 接口<br>COM1 Modem Audio Boot<br>COM2 Codec Codec Ethernet ROM（启动 ROM）<br>**----- 图片文字结束 -----**<br>
...
下一章将介绍 PCI Express 环境中的配置 (Configuration)。内容包括：实现 Function 配置寄存器的地址空间、Function 的发现 (Discovery) 方式、配置事务 (Configuration Transaction) 的生成与路由、PCI 兼容空间 (PCI-Compatible Space) 与 PCIe 扩展空间 (Extended Configuration Space) 之间的差异，以及软件如何区分端点 (Endpoint) 与桥 (Bridge)。
